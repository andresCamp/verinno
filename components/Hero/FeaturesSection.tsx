...
const FeaturesSection = () => {
  return (
    ...
    <div className='flex flex-col h-fit p-4 sm:py-16 sm:px-32 w-full gap-16 sm:-mt-20 '>

        {/* <h1 className='text-white text-3xl'>Your Partner in a Sustainable Energy Future</h1> */}
        <h1 className='text-primary font-bold text-4xl'>Your Partner in a Sustainable Energy Future</h1>
